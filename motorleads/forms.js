function send_marcas(){
    ...
    wanted_values= "name";
    url = "http://localhost/MotorLeads/forms.php?api_format="+api_format+"&wanted_values="+wanted_values;
...
function send_rest_values(){
    ...
    if(kilometraje =='' || color == ''){
        ...
        url = "http://localhost/MotorLeads/forms.php?selectedFilter="+datos+"&api_format="+api_format;
        location.href=url;
    }
}
